    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <form @submit.prevent="saveStudent" novalidate>
                    <fieldset>
                        <div class="form-group">
                          <label class="form-level mt-4">Student Class</label>
                          <input type="text" name="" id="" class="form-control" v-model="students.class" placeholder="Enter student class" aria-describedby="helpId">
                          <!-- <small id="helpId" class="text-muted">Help text</small> -->
                        </div>
                        <div class="form-group">
                          <label class="form-level mt-4">Student name</label>
                          <input type="text" name="" id="" class="form-control" v-model="students.name" placeholder="Enter student name">
                        </div>
                        <div class="form-group">
                          <label class="form-level mt-4">Email</label>
                          <input type="email" name="" id="" class="form-control" v-model="students.email_address" placeholder="Student Email">
                        </div>
                        <div class="form-group">
                          <label class="form-level mt-4">Contact Number</label>
                          <input type="number" name="" id="" class="form-control" v-model="students.contact_number" placeholder="Contact Number">
                        </div>
                        <div class="form-group">
                          <label class="form-level mt-4">Password</label>
                          <input type="password" name="" id="" class="form-control" v-model="students.password" placeholder="Password">
                        </div>
            ...
            if(!this.errors.length){
                ...
                await axios.post(url, formData).then((response) => { 
                    ...
                    if(response.status == 200){
                        this.students.class = '';
                        this.students.name = '';
                        this.students.email_address = '';
                        this.students.contact_number = '';
